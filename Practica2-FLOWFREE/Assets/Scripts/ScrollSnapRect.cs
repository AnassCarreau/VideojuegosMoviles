...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    [SerializeField] private Color selectedPage;
    [Tooltip("Container with page images (optional)")]
    [SerializeField] private Transform pageSelectionIcons;
    ...
    void Start()
    {
        ...
        _pageSelectionImages = lvlscroll.listInd;
    ...
    */
    ...
    private void SetPageSelection(int aPageIndex)
    {
        ...
        {
            _pageSelectionImages[_previousPageSelectionIndex].GetComponent<Image>().color = unselectedPage;
            _pageSelectionImages[_previousPageSelectionIndex].GetComponent<Image>().SetNativeSize();
        }

        // select new
        _pageSelectionImages[aPageIndex].GetComponent<Image>().color = selectedPage;
        _pageSelectionImages[aPageIndex].GetComponent<Image>().SetNativeSize();
